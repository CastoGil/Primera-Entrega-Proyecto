...
class Product {
  ...
  async loadEmptyFile() {
    try {
      ...
      throw new Error("Failed to load default products!", error);
    }
  }
  ...
  async saveProducts(products) {
    try {
      ...
      throw new Error("Products could not be saved!", error);
    }
  }
  ...
  async getById(id) {
    try {
      ...
      if (index < 0) {
        throw "The product you are looking for does not exist!";
      }
  ...
  async deleteById(id) {
    try {
      ...
      if (index < 0) {
        throw "The product to remove does not exist!";
      }
